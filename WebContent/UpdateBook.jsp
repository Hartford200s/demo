...
function doUpdate() {
	...
	if ($("#bookName").val() != $("#oriBookName").val()) {
		$.ajax({
			type: "POST",
					...
					<div class="form-container table-container">
						<form
							...
							<div class="form-group customerName_form_group">
								...
								<div class="col-sm-9">
									<s:textfield id="bookName" name="book.bookName" class="form-control" maxlength="50"></s:textfield>	
								</div>
							</div>
							<div class="form-group contactLastName_form_group">
								<label class="col-sm-3 control-label"> 圖書價格 </label>
								<div class="col-sm-9">
									<s:textfield id="bookPrice" name="book.bookPrice" class="form-control" maxlength="50"  onkeyup="return ValidateNumber($(this),value)"></s:textfield>
								</div>
							</div>
							<div class="form-group contactLastName_form_group">
								<label class="col-sm-3 control-label"> 圖書封面 </label>
								<div class="col-sm-9">
									<s:if test="book.hasImage()">
										<img width="180px" height="180px" src='${pageContext.request.contextPath}/<s:property value="book.bookImage"/>'>
									</s:if>
									<s:else>
										未上傳圖片
									</s:else>
							...
							<div class="form-group contactLastName_form_group">
								<label class="col-sm-3 control-label"> 修改圖書封面 </label>
								<div class="col-sm-9">
